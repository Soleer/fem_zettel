...
int main(int argc, char *argv[]) {
	...
	for (int i = 1; i < grids; i++) {
		...
		std::cout << std::endl << "The refinement from level " << i-1 << " to level " << i << " took " << end_s - start_s << " seconds." << std::endl;
	...
	std::cout << std::endl << "The refinement took " << end_s - start_s << " seconds" << std::endl;
